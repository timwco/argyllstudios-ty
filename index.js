...
var raptorImageMarkup='<img id="elRaptor" style="display: none; z-index:999999;" src="raptor/raptor.png" />'
var raptorAudioMarkup='<audio id="elRaptorShriek" preload="auto"><source src="raptor/raptor-sound.mp3" /><source src="raptor/raptor-sound.ogg" /></audio>';var locked=false;$('body').append(raptorImageMarkup);if(audioSupported){$('body').append(raptorAudioMarkup);}
